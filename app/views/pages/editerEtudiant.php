              ...
              <form action="editerEtudiant.php" method="POST">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="prenom" name="prenom_etudiant" required <?php echo "value='" . $etudiant['prenom_etudiant'] . "'" ?>>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="email" class="form-control" id="adr_email" name="adr_email" <?php echo "value='" . $etudiant['adr_email'] . "'" ?> required>
                  </div>
